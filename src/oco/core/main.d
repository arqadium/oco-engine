...
/++ ============================= M O D U L E ============================= ++
 +
 + TITLE:       Real Application Entry Point
 ...
 +              and pass them to the original C-linked main() function, now
 +              called ocoMain(), manually cleaning up afterward. This is
 +              necessary as without D's precedence over startup, a lot of
 +              things would quickly break due to the absence of D-specific
 +              initialisations.
 +/
